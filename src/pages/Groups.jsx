...
const Groups = () => {
    ...
    useEffect(() => {
        // if (chatId) {
        //     setGroupName(`Zammers `);
        //     setGroupNameUpdatedValue(`Zammers `);
        // }
    ...
    const ButtonGroup = (
        ...
        >
            <Button size="large" color="error" startIcon={<DeleteIcon />}
                variant="outlined" onClick={openConfirmDeleteHandler}>Delete Group</Button>
...

            {
                ...
                <Suspense fallback={<Backdrop open />}>
                    <ConfirmDeleteDialog open={confirmDeleteDialog}
                        handerClose={closeConfirmDeleteHandler}
